...
5. `<config-option>: <default-value> -[opt|req]`. Using this syntax you can see in a one liner which defaults the config-options in the `.cfg` have and if they are **required(req)** or **optional(opt)**
