...
Mounting point of the second disk. All mounting paths are supported beside: 
- `/root`
- `/`
- `/boot`
- `/var`
...
## govm.cfg
govm.cfg is setting metadata information that are needed for the software to function.
...
## Naming
Because the names of your directories in the config direcroty and virtual-machine names [matter](#how-is-the-ova-filename-generated) it is a good idea to choose the names that they represent the purpose of the virtual-machine or the group like you can see in the example tree-structure.
